    ...
    <>
      <nav
        className={clsx(
          ...
          isScrolled
            ? "bg-white/90 dark:bg-neutral-950/90 backdrop-blur-md shadow-sm dark:shadow-none"
            : "bg-transparent",
        )}
      >
          ...
          <div className='flex items-center justify-between h-16'>
            ...
            <div className='hidden md:flex items-center gap-4'>
              ...
              {isAuthenticated ? (
                <Dropdown
                  trigger={
                    <button className='flex items-center gap-2 p-2 rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-800 cursor-pointer'>
